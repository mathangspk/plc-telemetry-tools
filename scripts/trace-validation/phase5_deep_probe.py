...
def main():
    ...
    for group_name, commands in PROBE_TARGETS.items():
        ...
        for cmd in commands:
            ...
            status = 'FOUND' if (not is_children and success) or (is_children and 'unknown_name' not in resp and 'connection_failed' not in resp) else 'NOT_FOUND'
    ...
    # Save results
    with open(r'C:\local\opencode\codesys\scripts\phase5_deep_probe_results.json', 'w') as f:
