...
SIGNALS = [
    ...
    ('hoist_state', ['Lift/State', 'Lift/Status', 'Lift/Mode', 'Lift/OperatingState', 'Lift/RunState', 'System/LiftState']),
    ('hoist_load_kg', ['Lift/Load', 'Lift/LoadKg', 'Lift/ContainerMass', 'Lift/Weight', 'Spreader/Load', 'Spreader/LoadKg', 'System/Load']),
    ('tilt_sensor_deg', ['System/TiltAngle', 'System/Tilt', 'System/TiltDeg', 'System/Inclinometer', 'Lift/TiltAngle', 'Spreader/TiltAngle']),
    ...
    ('hoist_fault_code', ['Lift/FaultCode', 'Lift/Fault', 'Lift/ErrorCode', 'System/HoistFault', 'System/FaultCode', 'BMSAB/FaultCode', 'BMS/FaultCode']),
    ('bat_pack_current_signed', ['BMSAB/PackCurrent', 'BMS/PackCurrent']),
    ('bat_pack_voltage', ['BMSAB/PackVoltage', 'BMS/PackVoltage']),
    ('cycle_count', ['Lift/CycleCount', 'Lift/Cycles', 'System/CycleCount', 'System/HoistCycles', 'Lift/HoistCycleCount']),
]
...
def main():
    ...
    print('[+] Connected. Greeting: {}'.format(greeting[:200] if greeting else '(empty)'))
    ...
    out_path = 'C:\\\\local\\\\opencode\\\\codesys\\\\scripts\\\\mp01_validation_results.json'
