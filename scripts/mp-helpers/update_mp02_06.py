...
MP02 = [
    ...
    (
        "current_travelA",
        "DC bus current of travel drive A",
        "CANBusDrive/cTransA/Current",
        "present",
    ),
    (
        "current_travelB",
        "DC bus current of travel drive B",
        "CANBusDrive/cTransB/Current",
        "present",
    ),
    (
        "current_travelC",
        "DC bus current of travel drive C",
        "CANBusDrive/cTransC/Current",
        "present",
    ),
    (
        "current_travelD",
        "DC bus current of travel drive D",
        "CANBusDrive/cTransD/Current",
        "present",
    ),
    (
        "batt_voltage_travelA",
        "Battery voltage of travel drive A",
    ...
    (
        "torque_travelA",
        "Estimated motor torque of travel drive A",
    ...
    (
        "vehicle_speed_gps",
        "Vehicle speed from GPS RTK (external)",
        "N/A",
        "manual-only",
    ),
    (
        "position_steerA",
        "Steering position of wheel A (front-left)",
        "System/iSteerAPos",
        "present",
    ),
    (
        "position_steerB",
        "Steering position of wheel B (front-right)",
        "System/iSteerBPos",
        "present",
    ),
    (
        "position_steerC",
        "Steering position of wheel C (rear-left)",
        "System/iSteerCPos",
        "present",
    ),
    (
        "position_steerD",
        "Steering position of wheel D (rear-right)",
        "System/iSteerDPos",
        "present",
    ),
    (
        "motor_temp_steerA",
        "Motor winding temperature of steer drive A",
    ...
    (
        "bms_current",
        "Battery management system current (signed)",
    ...
    (
        "travel_fault_code_any",
        "Drive controller fault code (any drive)",
        "N/A",
        "no present",
    ),
    (
        "operating_mode",
        "Vehicle operating mode state",
...
MP03 = [
    ...
    (
        "bms_current",
        "Battery pack current (signed, +discharge / -regen)",
        "System/BMSAB/Current",
        "present",
    ),
    ...
    (
        "bat_energy_discharged_kwh",
        "Cumulative energy discharged this session",
        "N/A",
        "no present",
    ),
    (
        "bat_energy_regen_kwh",
        "Cumulative regen energy recovered this session",
        "N/A",
        "no present",
    ),
    (
        "bat_temp_max",
        "Maximum cell temperature across all modules",
        "N/A",
        "no present",
    ),
    (
        "bat_temp_min",
        "Minimum cell temperature across all modules",
        "N/A",
        "no present",
    ),
    (
    ...
    (
        "bat_charge_power_kw",
        "Charger power input during charging session",
        "System/BMSAB",
        "not validated",
    ),
...
MP04 = [
    (
        "motor_temp_travelA",
        "Travel motor A winding temperature",
        "CANBusDrive/cTransA/MotorTemp",
        "present",
    ),
    (
        "motor_temp_travelB",
        "Travel motor B winding temperature",
        "CANBusDrive/cTransB/MotorTemp",
        "present",
    ),
    (
        "motor_temp_travelC",
        "Travel motor C winding temperature",
        "CANBusDrive/cTransC/MotorTemp",
        "present",
    ),
    (
        "motor_temp_travelD",
        "Travel motor D winding temperature",
        "CANBusDrive/cTransD/MotorTemp",
        "present",
    ),
    (
        "cntrl_temp_travelA",
        "Travel controller A heatsink temperature",
        "CANBusDrive/cTransA/CntrlTemp",
        "present",
    ),
    (
        "cntrl_temp_travelB",
        "Travel controller B heatsink temperature",
        "CANBusDrive/cTransB",
        "not validated",
    ),
    (
        "cntrl_temp_travelC",
        "Travel controller C heatsink temperature",
        "CANBusDrive/cTransC",
        "not validated",
    ),
    (
        "cntrl_temp_travelD",
        "Travel controller D heatsink temperature",
        "CANBusDrive/cTransD",
        "not validated",
    ),
    (
        "motor_temp_winchA",
        "Hoist motor A winding temperature",
        "CANBusDrive/cWinchA/MotorTemp",
        "present",
    ),
    (
        "motor_temp_winchB",
        "Hoist motor B winding temperature",
        "CANBusDrive/cWinchB/MotorTemp",
        "present",
    ),
    (
        "motor_temp_winchC",
        "Hoist motor C winding temperature",
        "CANBusDrive/cWinchC/MotorTemp",
        "present",
    ),
    (
        "motor_temp_winchD",
        "Hoist motor D winding temperature",
        "CANBusDrive/cWinchD/MotorTemp",
        "present",
    ),
    (
        "steer_temp_motor_max",
        "Maximum steer motor temperature (all 4)",
        "CANBusDrive/cSteerA",
        "not validated",
    ),
...
MP05 = [
    ...
    (
        "bat_capacity_ah",
        "Measured usable battery capacity this cycle",
        "System/BMSAB",
        "not validated",
    ),
    (
    ...
    (
        "encoder_linearity_pct",
        "Encoder linearity check (all axes)",
        "System/Encoder",
        "not validated",
    ),
    (
        "fault_code_count_total",
        "Total fault events this session",
        "System/PLC",
        "not validated",
    ),
    ("fault_code_log", "Last fault code and timestamp", "System/PLC", "not validated"),
    (
        "radio_signal_loss_pct",
        "Radio remote signal loss rate",
        "System/Radio",
        "not validated",
    ),
    (
        "radio_response_ms",
        "Radio command response time",
        "System/Radio",
        "not validated",
    ),
    ...
    (
        ...
        "Connector and cable resistance spot check",
        "N/A",
        "manual-only",
    ),
    (
        "hmi_fault_export_count",
        "HMI fault log entry count (session)",
        "N/A",
        "manual-only",
    ),
    (
        "runtime_hours_total",
        "Total vehicle runtime hours",
        "System/Vehicle",
        "not validated",
    ),
]
...
MP06 = [
    (
        "batt_voltage_travelA",
        "DC bus voltage of travel drive A",
        "CANBusDrive/cTransA/BattVoltage",
        "present",
    ),
    (
        "current_travelA",
        "DC bus current of travel drive A (signed)",
        "CANBusDrive/cTransA/Current",
        "present",
    ),
    (
        "batt_voltage_travelB",
        "DC bus voltage of travel drive B",
        "CANBusDrive/cTransB",
        "not validated",
    ),
    (
        "current_travelB",
        "DC bus current of travel drive B (signed)",
        "CANBusDrive/cTransB/Current",
        "present",
    ),
    (
        "batt_voltage_travelC",
        "DC bus voltage of travel drive C",
        "CANBusDrive/cTransC",
        "not validated",
    ),
    (
        "current_travelC",
        "DC bus current of travel drive C (signed)",
        "CANBusDrive/cTransC/Current",
        "present",
    ),
    (
        "batt_voltage_travelD",
        "DC bus voltage of travel drive D",
        "CANBusDrive/cTransD",
        "not validated",
    ),
    (
        "current_travelD",
        "DC bus current of travel drive D (signed)",
        "CANBusDrive/cTransD/Current",
        "present",
    ),
    (
        "torque_travelA",
        "Motor torque of travel drive A (estimated)",
        "CANBusDrive/cTransA/Torque",
        "present",
    ),
    (
        "torque_travelB",
        "Motor torque of travel drive B (estimated)",
        "CANBusDrive/cTransB",
        "not validated",
    ),
    (
        "torque_travelC",
        "Motor torque of travel drive C (estimated)",
        "CANBusDrive/cTransC",
        "not validated",
    ),
    (
        "torque_travelD",
        "Motor torque of travel drive D (estimated)",
        "CANBusDrive/cTransD",
        "not validated",
    ),
    ...
    (
        "vehicle_speed_gps",
        "Vehicle speed from GPS RTK (ground truth)",
        "N/A",
        "manual-only",
    ),
    ("vehicle_speed_encoder", "Vehicle speed from wheel encoder", "N/A", "no present"),
