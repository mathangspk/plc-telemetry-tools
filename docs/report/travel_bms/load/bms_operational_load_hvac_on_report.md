...
- **Net Traction-only Energy Consumption Rate:** **2.3239 kWh/km**
  - *Verification:* The net traction energy rate of **2.3239 kWh/km** (for 20T load) is highly consistent with the specifications. It lies perfectly linear between the unladen spec (**~1.5 kWh/km**) and the 35T fully laden spec (**~3.5 kWh/km**).
...
> - The telemetry data confirms that the **load imbalance on drive C (transC) persists** under laden conditions.
...
3. **Standby Optimization:** Standby power with HVAC ON during this session averaged **1.84 kW**, indicating that the AC compressor was cycling off or running at a lower fan speed compared to yesterday's 3.42 kW standby test.
