...
- **CAN Interface for Apollo 4:** Đã tạo tệp tài liệu `Apollo 4.xlsx` (dựa trên `MJConnect_CANInterfaceV6.xlsx`) để đặc tả dữ liệu CAN interface riêng cho BMSA và BMSB (tách thành 2 sheet riêng biệt). Đã đính chính lại mapping: Nhiệt độ BMS là kiểu USINT (1 byte), Start Address là 550, tuân thủ đúng kiến trúc thực tế.
