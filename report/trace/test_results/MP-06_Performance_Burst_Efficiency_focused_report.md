...
| --- | ---: | ---: |
| **Active (PASS_ACTIVE)** | 19 | 100.0% |
| **Silent (SILENT)** | 0 | 0.0% |
| **Failed (FAIL)** | 0 | 0.0% |
| **Total Expected** | 19 | 100.0% |
...
| `batt_voltage_travelB` | `CANBusDrive/cTransB` | OK | YES | YES |
| `batt_voltage_travelC` | `CANBusDrive/cTransC` | OK | YES | YES |
| `batt_voltage_travelD` | `CANBusDrive/cTransD` | OK | YES | YES |
...
| `torque_travelB` | `CANBusDrive/cTransB` | OK | YES | YES |
| `torque_travelC` | `CANBusDrive/cTransC` | OK | YES | YES |
| `torque_travelD` | `CANBusDrive/cTransD` | OK | YES | YES |
